...
n_test_samples = 10
test_set_cos = {(x,): np.array([np.cos(4*np.pi*x)]) for x in np.arange(0, 1, 1 / n_test_samples)}
n_training_samples = 10000
training_set_cos = {(x,): np.array([np.cos(4*np.pi*x)]) for x in np.arange(0, 1, 1 / n_training_samples)}

n_test_samples = 10
test_set_sin = {(x,): np.array([np.sin(4*np.pi*x)]) for x in np.arange(0, 1, 1 / n_test_samples)}
n_training_samples = 10000
training_set_sin = {(x,): np.array([np.sin(4*np.pi*x)]) for x in np.arange(0, 1, 1 / n_training_samples)}
...
n_samples = 10000
training_set_helix = {(x,): np.array([np.cos(4*np.pi*x),np.sin(4*np.pi*x)]) for x in np.arange(0, 1 + 1 / n_training_samples, 1 / n_training_samples)}
n_test_samples = 10
test_set_helix = {(x,): np.array([np.cos(4*np.pi*x),np.sin(4*np.pi*x)]) for x in np.arange(0, 1 + 1 / n_training_samples, 1 / n_test_samples)}
